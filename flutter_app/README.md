...
Bu, `../` altındaki React Native sürümünün Flutter/Dart'a birebir aktarımıdır. Aynı
tasarım (`design_handoff_ne_zaman/Ne Zaman v2.dc.html`), aynı kurallar, aynı Türkçe
metinler — Flutter'ın kendi araçlarıyla yeniden yazılmış hâli.
